...
- [Локалізатори та перекладачі](#локалізатори-та-перекладачі)
  - [Спільноти](#спільноти)
- [Елементи комп'ютерних наук та інженерії програмного забезпечення](#елементи-компютерних-наук-та-інженерії-програмного-забезпечення) 
  - [Мови програмування](#мови-програмування)
  - [Системи керування версіями](#системи-керування-версіями)
  - [Мережі](#мережі)
- [Клієнтська частина](#клієнтська-частина)
  - [Веб](#веб)
  - [UI фреймворки](#ui-фреймворки)
  - [Бібліотеки управління станом](#бібліотеки-управління-станом)
- [Серверна частина](#серверна-частина)
- [DevOps](#devops)
  - [Інструменти](#інструменти)
- [Навчання](#навчання)
  - [Лістинги, списки](#лістинги-списки)
  - [Курси](#курси)
- [Довідкова інформація](#довідкова-інформація)
  - [Опитування](#опитування)
- [Інше](#інше)
  - [Легенда](#легенда)
  - [Ключові слова та слова для пошуку](#ключові-слова-та-слова-для-пошуку)
  - [Автори](#автори)
  - [Ліцензія](#ліцензія)

## Локалізатори та перекладачі

### Спільноти

#### Спільноти, що займаються технічною локалізацією/перекладом

- [Ukrainian Technical L10n Community (Discord)](https://discord.gg/2rqy8bQY)
- [VueJS Ukraine (GitHub)](https://github.com/vuejs-ua)
- [Лямбда (GitHub)](https://github.com/LambdaBooks)
- [WebDoky (GitHub)](https://github.com/webdoky)

#### Спільноти, що займаються локалізацією/перекладом

- [Localize.org.ua (Crowdin)](https://crowdin.com/profile/localize_org_ua)

#### Спільноти, що також мають проєкти із технічної локалізації/перекладу

- [Ukrainian Rust Community (GitHub)](https://github.com/rust-lang-ua)
- [GolangUA (GitHub)](https://github.com/GolangUA)
...
#### [Документація] WebDoky (MDN Web Docs)

- Статус перекладу: незалежний
- Вебсайт: [https://webdoky.org/](https://webdoky.org/) ([en](https://developer.mozilla.org/en-US/))
- Система перекладу: GitHub — [https://github.com/webdoky/content](https://github.com/webdoky/content)
- Як долучитися: [https://webdoky.org/docs/#tsikavo-pryiednuitesia](https://webdoky.org/docs/#tsikavo-pryiednuitesia)
- Мейнтейнери: [@webdoky](https://github.com/webdoky)
...
- Статус перекладу: незалежний
- Вебсайт: [https://react.org.ua/](https://react.org.ua/) ([en](https://react.dev/))
...
### Середовища виконання для JavaScript

#### [Вебсайт] Node.js

- Статус перекладу: офіційний
- Стан перекладу: завершений
- Вебсайт: [https://nodejs.org/uk](https://nodejs.org/uk) ([en](https://nodejs.org/en))
- Система перекладу: Crowdin — [https://crowdin.com/project/nodejs-web/uk](https://crowdin.com/project/nodejs-web/uk) ([проєкт](https://crowdin.com/project/nodejs-web))
- Оновлення на вебсайті:
  1. автоматична синхронізація в [GitHub-репозиторії](https://github.com/nodejs/nodejs.org) (з погодженням від мейнтейнера цього репозиторію)
  2. автоматичне оновлення (після потрапляння до головної гілки репозиторію)
- Як долучитися: [https://github.com/nodejs/nodejs.org/blob/main/TRANSLATION.md](https://github.com/nodejs/nodejs.org/blob/main/TRANSLATION.md)
- Мейнтейнери: [FobosPlayer](https://crowdin.com/profile/fobosplayer), [MaxVein](https://crowdin.com/profile/maxvein)

> **Примітка**: [Документація API](https://nodejs.org/docs/latest/api/) наразі не перекладається.
...
? — значення має бути уточнене

#### Статуси перекладу

- офіційний — переклад розміщується на платформі та/або у репозиторії оригіналу
- визнаний — переклад розміщується на платформі перекладача, але автор оригіналу має посилання на цей переклад
- незалежний — переклад розміщується на платформі перекладача, та автор не має посилання на цей переклад
  
_Інші статуси можуть бути додані пізніше._

### Ключові слова та слова для пошуку
...
Цей [проєкт розміщений на платформі GitHub](https://github.com/alinkedd/uk-tech-l10n-list) та підтримується [@alinkedd](https://github.com/alinkedd). Інші користувачі платформи можуть додавати свій вміст після погодження.

Вебсайт створений і розгорнутий за допомогою [GitHub Pages](https://pages.github.com/) та стилізований стандартною темою [Primer](https://github.com/pages-themes/primer).

### Ліцензія

Цей список (основний вміст вебсайту) має ліцензію [CC0 1.0 Універсальна](https://creativecommons.org/publicdomain/zero/1.0/deed.uk).

Файли вебсайту загалом мають відповідну ліцензію використаних інструментів GitHub Pages.
